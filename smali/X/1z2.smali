...
.method public synthetic constructor <init>(Lcom/whatsapp/util/crash/SigquitBasedANRDetector;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, LX/1z2;->A00:Lcom/whatsapp/util/crash/SigquitBasedANRDetector;

    iput-object p2, p0, LX/1z2;->A01:Ljava/lang/String;

    iput-object p3, p0, LX/1z2;->A02:Ljava/lang/String;
...
.method public final run()V
    ...
    iget-object v3, p0, LX/1z2;->A00:Lcom/whatsapp/util/crash/SigquitBasedANRDetector;

    iget-object v2, p0, LX/1z2;->A01:Ljava/lang/String;

    iget-object v4, p0, LX/1z2;->A02:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, v3, Lcom/whatsapp/util/crash/SigquitBasedANRDetector;->A05:LX/04A;

    new-instance v5, Ljava/io/File;

    iget-object v0, v0, LX/04A;->A03:LX/00j;
    ...
    :try_start_7
    iget-object v1, v3, Lcom/whatsapp/util/crash/SigquitBasedANRDetector;->A06:LX/04G;
    ...
    iget-object v0, v1, LX/04G;->A02:LX/1z5;

    invoke-static {v0}, LX/1z5;->A00(LX/1z5;)V
    ...
    iget-object v5, v3, Lcom/whatsapp/util/crash/SigquitBasedANRDetector;->A06:LX/04G;

    new-instance v7, LX/2Ws;

    invoke-direct {v7, v3, v4}, LX/2Ws;-><init>(Lcom/whatsapp/util/crash/SigquitBasedANRDetector;Ljava/io/File;)V

    iget-object v1, v5, LX/04G;->A05:Landroid/content/Context;
    ...
    :try_start_c
    iget-object v1, v5, LX/04G;->A02:LX/1z5;

    if-eqz v1, :cond_4

    iget v0, v5, LX/04G;->A00:I

    if-eqz v0, :cond_4

    invoke-static {v1}, LX/1z5;->A00(LX/1z5;)V

    :cond_4
    iget-wide v8, v5, LX/04G;->A01:J

    const-wide/16 v0, 0x1

    add-long/2addr v8, v0

    iput-wide v8, v5, LX/04G;->A01:J

    new-instance v4, LX/1z5;

    invoke-direct/range {v4 .. v9}, LX/1z5;-><init>(LX/04G;Landroid/app/ActivityManager;LX/1z6;J)V

    iput-object v4, v5, LX/04G;->A02:LX/1z5;

    const/4 v0, 0x1

    iput v0, v5, LX/04G;->A00:I
    ...
    invoke-virtual {v0, v4}, LX/04A;->A02(Ljava/io/File;)V
